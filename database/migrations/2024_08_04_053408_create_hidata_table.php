...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('hidata', function (Blueprint $table) {
            ...
            $table->decimal('inverter_power', $precision = 10, $scale = 2);
            $table->string('inverter_output_priority', 1);
            $table->string('inverter_charger_priority', 1);
